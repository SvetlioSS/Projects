namespace BugTrackingSystem.WebApi.Controllers
{
    ...
    using BugTrackingSystem.WebApi.Providers;
    using BugTrackingSystem.WebApi.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            Author user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
